...
public class EnglishForKids {
	 ...
	 */
	public EnglishForKids() { // bıraktığın yerde acma kodu: parametre girdik:JFrame parent
	...
	private void initialize() {
		...
		frame.setBounds(50, 25, 500, 400); // bıraktığın yerde acma kodu x ve y parametresi girildi
		...
		arkaplan.setIcon(new ImageIcon("img/Kaynakça-Hazırlama.jpg"));
