...
public class Units {
	...
	private void initialize() {
		...
		btnBack.setPreferredSize(btnContinue.getPreferredSize());
		...
		JButton btnContinue_5 = new JButton("CONTINUE");
		btnContinue_5.setEnabled(false);
		btnContinue_5.setBackground(new Color(255, 204, 153));
		btnContinue_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		panel_33.add(btnContinue_5, BorderLayout.EAST);
		btnBack_5.setPreferredSize(btnContinue_5.getPreferredSize());
	    ...
	    btnBack_6.setEnabled(false);
	    btnBack_6.setBackground(new Color(153, 255, 153));
	    panel_38.add(btnBack_6, BorderLayout.WEST);
	    ...
	    btnBack_6.setPreferredSize(btnContinue_6.getPreferredSize());
	    ...
	    JButton btnContinue_7 = new JButton("CONTINUE");
	    btnContinue_7.setEnabled(false);
	    btnContinue_7.setBackground(new Color(153, 255, 153));
	    panel_43.add(btnContinue_7, BorderLayout.EAST);
	    btnBack_7.setPreferredSize(btnContinue_7.getPreferredSize());
	    ...
	    btnContinue_10.setEnabled(false);
	    ...
	    btnContinue_12.setEnabled(false);
