...
public class Tests extends JComponent {
	...
	private void initialize() {
	    ...
	    label_1.setIcon(new ImageIcon("img/test1/icon100x100.png"));
	    label_1.setBounds(354, 6, 99, 100);
	    Test1.add(label_1);
	    
	    JLabel lblNewLabel_13 = new JLabel("New label");
	    lblNewLabel_13.setIcon(new ImageIcon("img/test1/London_Bridge-icon.png"));
	    lblNewLabel_13.setBounds(62, 184, 103, 100);
	    Test1.add(lblNewLabel_13);
	    
	    JLabel lblNewLabel_14 = new JLabel("New label");
	    lblNewLabel_14.setIcon(new ImageIcon("img/test1/london_icon_iii_by_luftie.png"));
	    lblNewLabel_14.setBounds(272, 184, 101, 93);
	    Test1.add(lblNewLabel_14);
	    
	    JLabel lblNewLabel = new JLabel("New label");
	    lblNewLabel.setIcon(new ImageIcon("img/test1/People_icon.png"));
	    ...
	    lblNewLabel_16.setIcon(new ImageIcon("img/test1/classyfishhh1_by_poniesandcompany-d848puu.png"));
	    lblNewLabel_16.setBounds(62, 485, 103, 67);
	    Test1.add(lblNewLabel_16);
	    
	    JLabel lblNewLabel_17 = new JLabel("New label");
	    lblNewLabel_17.setIcon(new ImageIcon("img/test1/4602457174.png"));
...
/**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**/	    
	    ...
	    lblTig_1.setIcon(new ImageIcon("img/test2/tiger.png"));
	    lblTig_1.setBounds(16, 47, 46, 75);
	    Test2.add(lblTig_1);
	    
	    JLabel lblEl = new JLabel("el");
	    lblEl.setIcon(new ImageIcon("img/test2/e.png"));
	    lblEl.setBounds(149, 47, 57, 75);
	    Test2.add(lblEl);
	    
	    JLabel lblTig = new JLabel("tig");
	    lblTig.setIcon(new ImageIcon("img/test2/Crocodile-icon.png"));
	    ...
	    lblCow.setIcon(new ImageIcon("img/test2/Black_Holstein_Cow-icon.png"));
	    ...
	    lblNewLabel_1.setIcon(new ImageIcon("img/test2/icon.jpg"));
	    lblNewLabel_1.setBounds(69, 184, 91, 70);
	    Test2.add(lblNewLabel_1);
	    
	    JLabel lblNewLabel_2 = new JLabel("New label");
	    lblNewLabel_2.setIcon(new ImageIcon("img/test2/hippo.png"));
	    lblNewLabel_2.setBounds(71, 331, 66, 75);
	    Test2.add(lblNewLabel_2);
	    
	    JLabel lblNewLabel_3 = new JLabel("New label");
	    lblNewLabel_3.setIcon(new ImageIcon("img/test2/be-the-bee-icon-1.png"));
	    lblNewLabel_3.setBounds(203, 329, 92, 93);
	    Test2.add(lblNewLabel_3);
	    
	    JLabel lblNewLabel_4 = new JLabel("New label");
	    lblNewLabel_4.setIcon(new ImageIcon("img/test2/Snake-icon (1).png"));
	    lblNewLabel_4.setBounds(69, 505, 97, 75);
	    Test2.add(lblNewLabel_4);
	    
	    JLabel lblNewLabel_5 = new JLabel("New label");
	    lblNewLabel_5.setIcon(new ImageIcon("img/test2/gamercat_icon1.gif"));
...
//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//***////***//**//**//**//**//**//	    
	    ...
	    lblNewLabel_6.setIcon(new ImageIcon("img/test3/Salt-icon.png"));
	    lblNewLabel_6.setBounds(16, 56, 90, 100);
	    Test3.add(lblNewLabel_6);
	    
	    JLabel lblNewLabel_7 = new JLabel("New label");
	    lblNewLabel_7.setIcon(new ImageIcon("img/test3/icon-apple.jpg"));
	    lblNewLabel_7.setBounds(196, 62, 89, 88);
	    Test3.add(lblNewLabel_7);
	    
	    JLabel lblNewLabel_8 = new JLabel("New label");
	    lblNewLabel_8.setIcon(new ImageIcon("img/test3/Giant_Lollipop_Cookie_Tree-icon.png"));
	    lblNewLabel_8.setBounds(341, 62, 110, 94);
	    Test3.add(lblNewLabel_8);
	    
	    JLabel lblNewLabel_9 = new JLabel("New label");
	    lblNewLabel_9.setIcon(new ImageIcon("img/test3/child-picking-apples-300x100.jpg"));
	    ...
	    lblNewLabel_10.setIcon(new ImageIcon("img/test3/6Mystery_Box-icon.png"));
	    lblNewLabel_10.setBounds(244, 362, 103, 106);
	    Test3.add(lblNewLabel_10);
	    
	    JLabel lblNewLabel_11 = new JLabel("New label");
	    lblNewLabel_11.setIcon(new ImageIcon("img/test3/Rocking_Chair-icon.png"));
...
//						
	    ...
	    lblNewLabel_12.setIcon(new ImageIcon("img/test4/TN_girl_drawing_art_05.jpg"));
	    lblNewLabel_12.setBounds(270, 388, 193, 96);
	    Test4.add(lblNewLabel_12);
	    
	    JLabel lblNewLabel_18 = new JLabel("New label");
	    lblNewLabel_18.setIcon(new ImageIcon("img/test4/little-girl-riding-a-bicycle_133065827.jpg"));
	    lblNewLabel_18.setBounds(304, 268, 127, 113);
	    Test4.add(lblNewLabel_18);
	    
	    JLabel lblNewLabel_19 = new JLabel("New label");
	    lblNewLabel_19.setIcon(new ImageIcon("img/test4/i6.gif"));
	    lblNewLabel_19.setBounds(315, 165, 97, 96);
	    Test4.add(lblNewLabel_19);
	    
	    JLabel lblNewLabel_20 = new JLabel("New label");
	    lblNewLabel_20.setIcon(new ImageIcon("img/test4/Spy_Mouse_icon.png"));
...
//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//***////***//**//**//**//**//**//
	    ...
	    lblNewLabel_22.setIcon(new ImageIcon("img/test5/img_2560_2c.png"));
	    lblNewLabel_22.setBounds(70, 484, 99, 107);
	    Test5.add(lblNewLabel_22);
	    
	    JLabel lblNewLabel_23 = new JLabel("New label");
	    lblNewLabel_23.setIcon(new ImageIcon("img/test5/woman-with-glasses-black-hair-th.png"));
...
//						
	    ...
	    lblNewLabel_24.setIcon(new ImageIcon("img/test5/4930951-car-icon.jpg"));
	    lblNewLabel_24.setBounds(282, 25, 99, 62);
	    Test5.add(lblNewLabel_24);
	    
	    JLabel lblNewLabel_25 = new JLabel("New label");
	    lblNewLabel_25.setIcon(new ImageIcon("img/test5/More_2_Love_Dog-icon.png"));
